...
{
    External (_SB_.PCI0.RP13.PXSX._DSM, MethodObj)    // dGPU ACPI Path
    External (_SB_.PCI0.RP13.PXSX._PS3, MethodObj)    // dGPU ACPI Path
    ...
    Device (NHG1)
    {
        ...
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            If (_OSI ("Darwin"))
            {
                ...
                {
                    // Card Off Request
                    \_SB.PCI0.RP13.PXSX._DSM (ToUUID ("a486d8f8-0bda-471b-a72b-6042a6b5bee0"), 0x0100, 0x1A, Buffer (0x04)
                        {
                             0x01, 0x00, 0x00, 0x03
                        })
                    // Card Off
